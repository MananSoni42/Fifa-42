...
FORM = {
    'default': {
            ...
            'L': [
                    ...
                    {'coord': P(W//4,H//2 - H//10), 'pos': 'DEF'}, {'coord': P(W//4, H//2 + H//10), 'pos': 'DEF'},
                    {'coord': P(5*W//16, H//7), 'pos': 'DEF'}, {'coord': P(5*W//16, 6*H//7), 'pos': 'DEF'},

                    {'coord': P(W//2,H//2 - H//10), 'pos': 'MID'}, { 'coord': P(W//2, H//2 + H//10), 'pos': 'MID'},
                    { 'coord': P(9*W//16, H//7), 'pos': 'MID'}, { 'coord': P(9*W//16, 6*H//7), 'pos': 'MID'},

                    {'coord': P(13*W//16,H//2 - H//5), 'pos': 'ATK'}, { 'coord': P(13*W//16, H//2 + H//5), 'pos': 'ATK'},
            ],
        },
    ...
    'balanced-1': {
            ...
            'L': [
                    ...
                    {'coord': P(W//2 + W//50, H//4), 'pos': 'MID'}, { 'coord': P(W//2 + W//50, 3*H//4), 'pos': 'MID'},
                    { 'coord': P(W//2 - 4*W//50, H//2), 'pos': 'MID'}, { 'coord': P(W//2 + 6*W//50, H//2), 'pos': 'MID'},
    ...
    'attacking-1': { # TODO
            ...
            'L': [
                    ...
                    {'coord': P(W//4,H//2 - H//4), 'pos': 'DEF'}, {'coord': P(W//4 - W//50, H//2), 'pos': 'DEF'},
                    {'coord': P(W//4, H//2 + H//4), 'pos': 'DEF'},

                    {'coord': P(W//2,H//2 - H//10), 'pos': 'MID'}, { 'coord': P(W//2,H//2 + H//10), 'pos': 'MID'},
                    { 'coord': P(9*W//16, H//5), 'pos': 'MID'}, { 'coord': P(9*W//16, 4*H//5), 'pos': 'MID'},

                    {'coord': P(24*W//32, H//7), 'pos': 'ATK'}, { 'coord': P(24*W//32, 6*H//7), 'pos': 'ATK'},
    ...
    'attacking-2': {
            ...
            'L': [
                    ...
                    {'coord': P(13*W//16,H//2 - H//10), 'pos': 'ATK'}, { 'coord': P(13*W//16,H//2 + H//10), 'pos': 'ATK'},
                    {'coord': P(24*W//32, H//7), 'pos': 'ATK'}, { 'coord': P(24*W//32, 6*H//7), 'pos': 'ATK'},
            ],
        },
    'attacking-3': {
            ...
            'L': [
                    ...
                    {'coord': P(W//2,H//2 - H//5), 'pos': 'MID'}, { 'coord': P(W//2, H//2 + H//5), 'pos': 'MID'},

                    {'coord': P(28*W//32, H//2 - H//10), 'pos': 'ATK'}, { 'coord': P(28*W//32, H//2 + H//10), 'pos': 'ATK'},
                    {'coord': P(26*W//32, H//7), 'pos': 'ATK'}, { 'coord': P(26*W//32, 6*H//7), 'pos': 'ATK'},
            ],
        },
    'defensive-1': {
            ...
            'L': [
                    ...
                    {'coord': P(W//4 - W//50, H//2), 'pos': 'DEF'}, {'coord': P(W//4, 9*H//28), 'pos': 'DEF'},
                    {'coord': P(W//4, 19*H//28), 'pos': 'DEF'}, {'coord': P(W//4 + W//12, H//7), 'pos': 'DEF'},
    ...
    'defensive-2': {
            ...
            'L': [
                    ...
                    {'coord': P(W//2,H//2 - H//10), 'pos': 'MID'}, { 'coord': P(W//2,H//2 + H//10), 'pos': 'MID'},
                    { 'coord': P(19*W//32, H//5), 'pos': 'MID'}, { 'coord': P(19*W//32, 4*H//5), 'pos': 'MID'},
    ...
    'defensive-3': {
            ...
            'L': [
                    ...
                    {'coord': P(W//2 - W//12, H//2 - H//50), 'pos': 'MID'}, { 'coord': P(W//2 + W//50, 9*H//28), 'pos': 'MID'},
                    { 'coord': P(W//2 + W//50, 19*H//28), 'pos': 'MID'}, { 'coord': P(W//2 + W//6, H//7), 'pos': 'MID'},
...
for key in FORM.keys(): # Fill in right side counterparts of all formations
    FORM[key]['R'] = [{ 'coord': P(W,H) - form['coord'], 'pos': form['pos']} for form in FORM[key]['L']]
